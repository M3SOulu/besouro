 ...
 */
public final class JacocoFileExecution implements ICoverageVisitor {
	 ...
	 *            stream for outputs
	 */
	public JacocoFileExecution(final PrintStream out) {
		this.out = out;
	...
	public static void main(final String[] args) throws IOException {
		new JacocoFileExecution(System.out).execute(args);
	}
